...
export function getKnownAdapters(): AdapterInfo[] {
  return [
    ...
    // === LP ===
    {
      ...
      description: 'Uniswap V3 concentrated liquidity - create positions, add/remove liquidity, collect fees. Pro adapter deployed on Ethereum only.',
      chains: ['MAINNET'],
      category: 'lp',
    },
    ...
    // === FLASH LOANS ===
    {
      ...
      description: 'Balancer flash loans - borrow and repay within a single transaction for arbitrage, liquidation, or collateral swaps',
      chains: ['ARBITRUM_ONE', 'BASE', 'MAINNET'],
      category: 'flashloan',
    },
