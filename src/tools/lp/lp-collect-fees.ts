...
export const lpCollectFeesTool = {
  ...
  description: 'Collect accumulated fees from a concentrated liquidity position through a Factor vault. Supports Uniswap V3, Camelot V3 (Arbitrum), and Aerodrome (Base).',
  inputSchema: {
    type: 'object',
    properties: {
      vaultAddress: {
