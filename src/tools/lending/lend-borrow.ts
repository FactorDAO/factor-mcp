...
export const lendBorrowTool = {
  ...
  description: 'Borrow assets from a lending protocol (Aave, Compound V3, or Morpho) through a Factor vault. Requires collateral to be supplied first.',
  inputSchema: {
    type: 'object',
    properties: {
      vaultAddress: {
      ...
      debtAddress: {
        type: 'string',
        description: 'Token address to borrow (required for aave and compoundV3)',
      },
      marketAddress: {
        type: 'string',
